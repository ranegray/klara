...
Everything in this package is pure stdlib. The agent (klara-agent) and the
backends (klara-sim-isaac now, klara_robot_api over ROS 2 later) both depend
on this package; nothing here may ever import a simulator or ROS.
"""

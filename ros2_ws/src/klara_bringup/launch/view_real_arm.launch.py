...
Examples:
    ros2 launch klara_bringup view_real_arm.launch.py
    ros2 launch klara_bringup view_real_arm.launch.py enable_torque:=true
"""
...
def generate_launch_description():
    bringup_share = Path(get_package_share_directory("klara_bringup"))
    description_share = Path(get_package_share_directory("klara_description"))

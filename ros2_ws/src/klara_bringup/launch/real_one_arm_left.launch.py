...
Pre-flight:
    1. ros2 run klara_hardware scan_bus1            # confirm IDs 1-8 healthy
    2. ros2 run klara_hardware calibrate_bus1       # interactive; writes ~/.xle/bus1_calibration.yaml

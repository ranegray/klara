...
setup(
    ...
    entry_points={
        "console_scripts": [
            "color_object_detector_node = klara_perception.color_object_detector_node:main",
            "reach_to_pose_node = klara_perception.reach_to_pose_node:main",
        ],
    },
)

...
Usage:
    ros2 run klara_hardware record_left_arm_run                  # name=run, dir=./bags
    ros2 run klara_hardware record_left_arm_run stow_test
    ros2 run klara_hardware record_left_arm_run reach1 --output-dir ~/runs

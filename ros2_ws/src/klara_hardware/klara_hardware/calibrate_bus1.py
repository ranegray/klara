...
Usage:
    ros2 run klara_hardware calibrate_bus1
    ros2 run klara_hardware calibrate_bus1 --only Rotation_L,Pitch_L
    ros2 run klara_hardware calibrate_bus1 --output ./my_cal.yaml
    ros2 run klara_hardware calibrate_bus1 --no-range          # skip step 3
"""
...
from klara_hardware._sdk import load_sdk

scs = load_sdk()

from klara_hardware.bus1_layout import (
...
def main(argv=None) -> int:
    ...
    print("next: ros2 launch klara_bringup view_real_arm.launch.py enable_torque:=true")
    return 0

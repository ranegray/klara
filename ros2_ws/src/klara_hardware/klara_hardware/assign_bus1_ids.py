...
Usage:
    ros2 run klara_hardware assign_bus1_ids
    ros2 run klara_hardware assign_bus1_ids --only 7,8         # head only
    ros2 run klara_hardware assign_bus1_ids --port /dev/ttyACM1
"""

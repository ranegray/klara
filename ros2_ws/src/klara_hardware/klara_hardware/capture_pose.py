...
Usage:
    ros2 run klara_hardware capture_pose stow
    ros2 run klara_hardware capture_pose ready --output ~/my_pose.yaml
    ros2 run klara_hardware capture_pose stow --pose-dir ~/.xle/poses
"""
...
def main(argv=None) -> int:
    ...
    print(f"next: ros2 run klara_hardware goto_pose {args.name}")
    return 0
